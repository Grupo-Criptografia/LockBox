    ...
    render() {
        return (
            <div className="md:flex flex-col h-auto w-4/5 bg-white">
                <div className="px-6 py-10 bg-color2">
                ...
                <div className="px-20 py-3 bg-white text-justify">
                <p className="text-black text-lg"> Unlock the power
                ...
                <ul className="px-10">
                    <li>
                        <p className="mt-4 text-lg text-black whitespace-pre-line lg:text-base flex">
                            ...
                            <strong className="font-bold mr-2 text-lg">Encrypt:</strong> <p className="text-black text-lg">Transform your messages into
                    ...
                    <li>
                        <p className="mt-4 text-lg text-black whitespace-pre-line lg:text-base flex">
                            ...
                            <strong className="font-bold mr-2 text-lg">Decrypt:</strong><p className="text-black text-lg">Reveal hidden secrets
                                    behind the codes.</p> 
                        </p>
                    </li>
                    <li>
                        <p className="mt-4 text-lg text-black whitespace-pre-line lg:text-base flex">
                            ...
                            <strong className="font-bold mr-2 text-lg">Attack: </strong><p class="text-black text-lg">

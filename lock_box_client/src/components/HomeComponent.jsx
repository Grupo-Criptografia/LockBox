        ...
        return (
            <div className="md:flex  h-auto w-auto bg-brownish1 place-content-center py-20 ">
                <div
                    ...
                    <div>
                        <h2 className="text-3xl font-bold text-black dark:text-white lg:text-4xl">LOCK BOX</h2>
                        ...
                        <ul className="px-5">
                            <li>
                                <p className="mt-4 text-sm text-black whitespace-pre-line lg:text-base flex">
                                    ...
                                    <strong className="font-bold mr-2">Encrypt:</strong> <p class="text-charcoal">Transform your messages into
                            ...
                            <li>
                                <p className="mt-4 text-sm text-black whitespace-pre-line lg:text-base flex">
                                    ...
                                    <strong className="font-bold mr-2">Decrypt:</strong><p class="text-charcoal">Reveal hidden secrets
                                    behind the codes.</p> 
                                </p>
                            </li>
                            <li>

        ...
        return (
            <aside
                className="flex flex-col w-64 h-auto px-5 py-8 overflow-y-auto bg-charcoal border-r rtl:border-r-0 rtl:border-l">
                        <span
                            className="flex title-font text-base font-medium items-center uppercase text-ivory mb-4 md:mb-0">Crypto - Systems</span>
                        ...
                        <div className="space-y-3">
                            <ul className="menu">
                                <li>
                                    ...
                                    <details>
                                        <summary>
                                            <label className="px-3 text-base text-ivory uppercase">Affine</label>
                                        </summary>
                                        <ul>
                                            <li>
                                                <Link
                                    ...
                                    <details>
                                        <summary>
                                            <label className="px-3 text-base text-ivory uppercase">Permutation</label>
                                        </summary>
                                        <ul>
                                            <li>
                                                <Link
                                    ...
                                    <details>
                                        <summary>
                                            <label className="px-3 text-base text-ivory uppercase">Vigenere</label>
                                        </summary>
                                        <ul>
                                            <li>
                                                <Link

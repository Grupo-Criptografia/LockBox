                ...
                <div>
                    <div className="text-center w-full mb-10">
                        <h1 className="sm:text-3xl text-2xl font-medium text-center title-font text-gray-900 mb-4">
                            User Guide for Hill Decryption Text
                        </h1>
                    </div>
                            ...
                            <div className="grid md:grid-cols-2 grid-cols-1 md:gap-2 gap-1 md:w-3/4 md:pr-10 md:py-6">
                                ...
                                <div className="flex col-span-2 md:col-span-1 pb-6">
                                    <div className="flex-grow pl-4">
                                        ...
                                        <p className="leading-relaxed">Enter the decryption key (k) is a square matrix
                                            (2x2, 3x3, etc.) that will be used for decryption. </p>
                                        <p className="leading-relaxed mt-1"> Each element of the matrix should be a
                                            number, and the entire matrix works in modulo 26 (representing 26 letters of
                                            the alphabet).</p>
                                ...
                                <div className="flex col-span-2 pb-6">
                                    <div className="flex flex-col pl-4">
                                        ...
                                        <p className="leading-relaxed">
                                            Keep your key matrix that used in encryption.
                                        </p>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <ul className="ml-5">
                                            <li className="list-disc">
                                                <p className="mt-2 text-md break-all">
                                                    <span className="font-bold">Cipher text:</span> {data.plain_text}
                                                </p>
                                            </li>
                                            <li className="list-disc">
                                                <p className="mt-2 text-md break-all">
                                            ...
                                            <li className="list-disc">
                                                <p className="mt-2 text-md break-all">
                                                    <span className="font-bold">Plain text:</span> {data.cipher_text}
                                                </p>
                                            </li>
                                        </ul>
                                    </div>

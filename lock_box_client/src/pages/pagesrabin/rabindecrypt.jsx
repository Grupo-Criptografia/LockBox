                ...
                <div>
                    <div className="text-center w-full mb-10">
                        <h1 className="sm:text-3xl text-2xl font-medium text-center title-font text-gray-900 mb-4">
                            User Guide for Rabin Decryption
                        </h1>
                    </div>
                            ...
                            <div className="grid md:grid-cols-2 grid-cols-1 md:gap-2 gap-1 md:w-3/4 md:pr-10 md:py-6">
                                <div className="flex pb-6 col-span-2 md:col-span-1 w-full">
                                    <div className="flex-grow pl-4">
                                        ...
                                        <p className="leading-relaxed">
                                            In the first field of the form, enter the cipher text you received. This is
                                ...
                                <div className="flex col-span-2 md:col-span-1 pb-6">
                                    <div className="flex-grow pl-4">
                                        <h2 className="font-medium title-font text-base text-gray-900 mb-1 trackng-wider">
                                            2. Enter Your Private Key (p, q):
                                        </h2>
                                        <p className="leading-relaxed">In the second field, input your Rabin private
                                            key. The Rabin private key consists of two large prime numbers,
                                            p and q, used in the decryption process.
                                        </p>
                                ...
                                <div className="flex md:col-span-1 pb-6">
                                    <div className="flex-grow pl-4">
                                        ...
                                        <p className="leading-relaxed">
                                            Note that due to the nature of the Rabin crypto-system, the decryption might
                                            result in multiple possible messages. Additional context or information is
                                            usually required to identify the correct message.
                                        </p>
                                    </div>
                                </div>
                                <div className="flex col-span-2 pb-6">
                                    <div className="flex flex-col pl-4">
                                        ...
                                        <p className="leading-relaxed">
                                            Ensure that you are using cryptographic methods like the Rabin crypto-system
                                            for legal and ethical purposes only.
                                        </p>
                                    </div>
                                </div>
                            </div>

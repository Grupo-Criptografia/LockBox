...
export function AesEncrypt() {
    ...
    const generateAESKey = async () => {
        const key = await window.crypto.subtle.generateKey(
            {name: "AES-CBC", length: 128}, // Changed to 128 bits
            true,
            ["encrypt", "decrypt"]
        );
                            ...
                            <div className="grid md:grid-cols-2 grid-cols-1 md:gap-2 gap-1 md:w-3/4 md:pr-10 md:py-6">
                                ...
                                <div className="flex col-span-2 md:col-span-1 pb-6">
                                    <div className="flex-grow pl-4">
                                        ...
                                        <p className="leading-relaxed mt-1"> Example of AES keys (in hexadecimal
                                            format):</p>
                                        <ul className="ml-5 list-disc">
                                            <li>
                                                <p className="leading-relaxed mt-1"> 128-bit Key:
                                                    6E629F55874E394F5F3C7E731B031B3E</p>
                                            </li>
                                        </ul>
                                ...
                                <div className="flex col-span-2 pb-6">
                                    <div className="flex flex-col pl-4">
                                        ...
                                        <p className="leading-relaxed">
                                            It's crucial to save both the encrypted image and the encryption key.
                                            Without the key, it will be impossible to decrypt and retrieve the original
                                            image.
                                        </p>
                                    </div>
                                </div>

            ...
            <div>
                <div className="text-center w-full mb-10">
                    ...
                    <p className="text-base leading-relaxed xl:w-2/4 md:w-3/4 mx-auto">
                        ...
                        messages that have been encrypted using the Affine cipher and a frecuency analysis is done. In this guide, we will explain how to use it.
                        </p>
                </div>
                        ...
                        <div className="grid md:grid-cols-2 grid-cols-1 md:gap-2 gap-1 md:w-3/4 md:pr-10 md:py-6">
                            ...
                            <div className="flex col-span-2 pb-6">
                                <div className="flex-grow pl-4">
                                    ...
                                    <p className="leading-relaxed">
                                        Once you've entered the Attack button it will be shown on the side the cipher text, plain text and the key found during the attack.
                                    </p>
                                </div>
                            </div>
                            <div className="flex col-span-2 pb-6">
                                <div className="flex flex-col pl-4">
                                    ...
                                    <p className="leading-relaxed">
                                        Please remember that this attack assumes that the text has been encrypted using a Affine Cipher. It may not be effective if another encryption method is used or if the language of the message is unknown.
                                    </p>
                                </div>
                            </div>
                        </div>
